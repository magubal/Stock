...
> **핵심 원칙**: 현재 시장을 지배하는 **투자심리의 핵심요소들의 기대와 우려**를 종합적으로 평가하고,
> 투자가능성의 영역(3개월, 6개월, 1년)으로 나누어 **현재부터 기간별 기대수익률**을 추정한다.

**투자적격성 판단 기준:**

| 판단 요소 | 평가 기간 | 핵심 질문 |
|----------|----------|----------|
| 투자심리 과열 여부 | 3, 6, 12개월 | 현재 투자심리가 과열이 아닌가? |
| 잠재적 우려요소 | 기간별 미래 일정/이슈 | 기대요소 대비 확연히 낮은가? |
| 하락가능성 분석 | 장기 시계열 | 하락가능성이 가장 낮은 타이밍인가? |

**투자 타이밍 핵심:**
> 현재 투자심리가 과열이 아니며, 잠재적 우려요소들(기간별 미래 일정/이슈들)이 
> 기대요소들 대비 확연히 낮다면... **좋은 투자진입(매수) 시점**으로 볼 수 있다.
